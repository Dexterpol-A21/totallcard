...
// Asumimos que los archivos estaran en public/lanyard/ para facilitar el acceso en Astro
// o los puedes colocar en src/assets/lanyard/ y cambiar la importación.
// We will load the assets directly from the public folder
const cardGLB = '/lanyard/card.glb';
const lanyardTexture = '/lanyard/custom-cord.svg';
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false }) {
  ...
  // Mejorar la calidad de la textura (Nitidez extrema al verla de lado)
  logoTexture.anisotropy = gl.capabilities.getMaxAnisotropy();
  logoTexture.minFilter = THREE.LinearMipmapLinearFilter;

  // Dynamic anchor position relative to top-right of screen
  const anchorX = viewport.width / 2 - 2.5; // Adjusted to mimic the previous 450px box
  const anchorY = viewport.height / 2; // Anchored at the absolute top of the screen
